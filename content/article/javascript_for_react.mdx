...
date: 2023-12-20
description: 동등 비교, 함수, 클래스, 클로저, 이벤트 루프와 비동기 통신, 타입스크립트
thumbnail: https://velog.velcdn.com/images/hyejeong/post/36476f8f-15c9-47ac-95f8-277d4507e46b/React.jpeg
category: React
---
...
| Number    | -(2<sup>53</sup> - 1)과 2<sup>53</sup> - 1 사이의 값을 저장 | 정수, 실수, 진법을 구분해 저장하지 않는다.                                                                                                    |
