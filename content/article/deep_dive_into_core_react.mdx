...
date: 2023-12-25
description: JSX, 가상 DOM과 리액트 파이버, 클래스형 컴포넌트와 함수형 컴포넌트, 렌더링, 메모이제이션
thumbnail: https://ko.react.dev/images/home/conf2021/cover.svg
category: React
---
...
- 렌더 단계(Render Phase): `type`, `props`, `key`를 비교하고 하나라도 변경된 것이 있으면 변경이 필요한 컴포넌트로 체크
